...
#
# return vector of probabilities that the observations were detected given they
# were at the specified distance and assuming that g(0)=1 (ie a standard line
# transect detection function).
